...
The homepage renders the catalog statically and provides client-side filters for one or more categories and a publisher. The filtering controls do not require a runtime API.
